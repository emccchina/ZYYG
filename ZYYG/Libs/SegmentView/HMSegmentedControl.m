...
- (void)commonInit {
    ...
    self.font = [UIFont systemFontOfSize:18];//[UIFont fontWithName:@"STHeitiSC-Light" size:18.0f];
    self.textColor = kGrayColor;//[UIColor blackColor];
    self.selectedTextColor = kRedColor;//[UIColor blackColor];
    self.backgroundColor = [UIColor colorWithRed:240.0/255.0 green:240.0/255.0 blue:240.0/255.0 alpha:1.0];//[UIColor whiteColor];
    self.opaque = NO;
    self.selectionIndicatorColor = kRedColor;//[UIColor colorWithRed:52.0f/255.0f green:181.0f/255.0f blue:229.0f/255.0f alpha:1.0f];
